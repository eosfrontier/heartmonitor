 ...
 */
#define USB_CFG_VENDOR_NAME     'm','o','n','s','u','w','e','.','n','l'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'H','e','a','r','t','P','a','d','d','l','e'
 ...
 */
#define USB_CFG_INTERFACE_CLASS     0x00  /* HID */ /* define class here if not at device level */
